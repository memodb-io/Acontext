/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 270b57f1667040598f3e97113d5d9636)
...
declare namespace Cloudflare {
	interface Env {
		...
		D1: D1Database;
		WORKER_SELF_REFERENCE: Fetcher /* acontext-landingpage */;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAYLOAD_SECRET" | "NEXT_PUBLIC_SERVER_URL">> {}
}
