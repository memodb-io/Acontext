...
func runLogin(cmd *cobra.Command, args []string) error {
	...
	if auth.IsTTY() {
		...
		fmt.Println()
		fmt.Println("     If the user already has an API key:")
		fmt.Println("       acontext dash projects select --project <project-id> --api-key <sk-ac-...>")
		fmt.Println()
		fmt.Println("     If the user wants to generate a new key (WARNING: invalidates existing key):")
		fmt.Println("       acontext dash projects select --project <project-id> --rotate")
		fmt.Println()
