...
export const SKILL_REMINDER = `MANDATORY SKILL READING AND EXECUTION PROTOCOL:
...
export const SANDBOX_TEXT_EDITOR_REMINDER = `The text_editor_sandbox tool enables viewing, creating, and modifying text files within
...
export const SANDBOX_BASH_REMINDER = `When to use the bash_execution_sandbox tool directly:
