...
func (m *mockAssetReferenceRepo) BatchIncrementAssetRefsWithCounts(_ context.Context, _ uuid.UUID, _ []repo.AssetRefIncrement) error {
	return nil
}

func (m *mockAssetReferenceRepo) ListS3KeysByProject(_ context.Context, _ uuid.UUID) ([]string, error) {
	return nil, nil
}
