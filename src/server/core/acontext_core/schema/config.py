...
class CoreConfig(BaseModel):
    ...
    skill_learn_lock_ttl_seconds: int = 240  # 4 min — agent phase only (5 iters × ~40s + 20% headroom)
    skill_learn_agent_retry_delay_seconds: int = 16  # retry delay on lock contention (240s TTL / 16s ≈ 15 retries worst-case)
