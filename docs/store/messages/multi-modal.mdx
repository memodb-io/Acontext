...
<Tip>
You can associate a session with a specific user by passing the `user` parameter when creating it. 
This enables per-user resource management and cleanup. See [Per-user Resources](/chore/per-user) for details.
</Tip>
...
- [OpenAI Files](https://platform.openai.com/docs/guides/pdf-files?api-mode=chat#page-top)
- [Anthropic Files](https://docs.claude.com/en/docs/build-with-claude/pdf-support)
...
View your messages in the dashboard
</Card>
</CardGroup>
