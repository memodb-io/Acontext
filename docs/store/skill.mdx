...
<Card title="Agentic Skill Content Tools" icon="wand-magic-sparkles" href="/tool/skill_tools">
Enable your agent to access and utilize skills with pre-built tools, NO SANDBOX REQUIRED.
</Card>
