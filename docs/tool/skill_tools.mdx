...
To execute skill scripts, use [Sandbox Execution Tools](/tool/bash_tools#mounting-skills-in-sandbox) which allows mounting skills directly into a sandbox filesystem.
</Warning>
